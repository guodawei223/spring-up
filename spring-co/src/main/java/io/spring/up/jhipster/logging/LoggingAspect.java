package io.spring.up.jhipster.logging;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(com.mbcloud.auth.repository..*)" +
            " || within(com.mbcloud.auth.service..*)" +
            " || within(com.mbcloud.auth.web.rest..*)")
    ...
    public void logAfterThrowing(final JoinPoint joinPoint, final Throwable e) {
        if (this.env.acceptsProfiles(JHipsterConstants.SPRING_PROFILE_DEVELOPMENT)) {
            this.log.error("Exception in {}.{}() with cause = \'{}\' and exception = \'{}\'", joinPoint.getSignature().getDeclaringTypeName(),
